...
class RedisClient:
    def __init__(self, host=None, port=None, db=None):
        self.host = host if host else os.getenv('SESSION_STORAGE_HOST')
        self.port = port if port else os.getenv('SESSION_STORAGE_PORT')
        self.db = db if db else os.getenv('SESSION_STORAGE_DB_NUMBER')
