...
class MongoClient:
    def __init__(self, host:str=None, port:int=None, username:str=None, password:str=None, database:str=None, collection:str=None):
        self.host = host if host else os.getenv("DB_HOST")
        self.port = port if port else os.getenv("DB_PORT")
        ...
        self.collection = collection if collection else os.getenv('DB_COLL_NAME')
